...
export default function About() {
    ...
    return (
        <section id='about' className='item-title'>
                                                ...
                                                <div className="align-items-start" data-aos="zoom-in" data-aos-delay="400">
                                                    <div className="row">
                                                        <div className="col-md-5">
                                                            <img src={require('../../assets/images/image 1.svg').default} alt="alt" />
                                                        </div>
                                                        <div className="col-md-7">
                                                            <h1 className="display-6 fw-bold pt-3">NFT to the bone makes you collect project 3D</h1>
